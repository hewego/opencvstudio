...
UINT GetMouseScrollLines()
{
	...
	*/
	...
	VER_SET_CONDITION(dwlConditionMask, VER_PLATFORM_WIN32_WINDOWS, op);
	
	if (!VerifyVersionInfo(&VersionInfo, VER_PLATFORMID | VER_MINORVERSION | VER_MAJORVERSION, dwlConditionMask))
	{
        HKEY hKey;
...
void CGridCtrl::OnLButtonDown(UINT nFlags, CPoint point)
{
	...
	//20170504 add jc
	SendMessageToParent(m_LeftClickDownCell.row, m_LeftClickDownCell.col, NM_LDOWN);
